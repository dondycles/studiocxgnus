...
$(window).scroll(function () {
  ...
  topBlur.classList.add("active");
  setTimeout(() => {
    menu.classList.remove("hideShow");
    topBlur.classList.remove("active");
  }, 500);
});

const navLoadingContainer = document.querySelector(".navLoadingContainer");
const loadingBG = document.querySelector(".loadingBG"),
  loadingBGRight = document.querySelector(".loadingBGRight"),
  loadingBGLeft = document.querySelector(".loadingBGLeft"),
  loadingBGBottom = document.querySelector(".loadingBGBottom"),
  loadingBGTop = document.querySelector(".loadingBGTop");
...
const bottomLine = document.querySelector("#bottomLine"),
  upperLine = document.querySelector("#upperLine");
...
const navMainMenuContainer = document.querySelector(".mavMainMenuContainer"),
  navMainMenuLeft = document.querySelector(".navMainMenuLeft"),
  navMainMenuRight = document.querySelector(".navMainMenuRight"),
  navMainMenuCenter = document.querySelector(".navMainMenuCenter"),
  rightMenuItemImg = document.querySelectorAll(".rightMenuItemImg"),
  leftMenuItemImg = document.querySelectorAll(".leftMenuItemImg"),
  centerMenuItemImg = document.querySelector(".centerMenuItemImg"),
  navBgImgDots = document.querySelector(".navBgImgDots"),
  navBgSparkle = document.querySelectorAll(".navBgSparkle");

let screenWidth;
setInterval(function () {
  screenWidth = parseFloat(window.innerWidth);
  if (screenWidth < 825) {
    navMainMenuContainer.style.transform =
      "scale(" + screenWidth / 1200 + ") translateY(20%)";
  }
  if (screenWidth > 825) {
    navMainMenuContainer.style.transform =
      "scale(" + screenWidth / 2000 + ") translateY(20%)";
  }
}, 5);
...
const audioContainer = document.querySelector("#audioContainer"),
  ...
  pauseMusic = document.querySelector("#pauseMusic"),
  nextMusic = document.querySelector("#nextMusic"),
  prevMusic = document.querySelector("#prevMusic"),
  arrowMusicL = document.querySelector("#arrowMusicL"),
  arrowMusicR = document.querySelector("#arrowMusicR"),
  musicOpen = document.querySelector("#musicOpen"),
  musicClose = document.querySelector("#musicClose"),
  audioContainer3 = document.querySelector(".audioContainer3"),
...
audio.volume = 0.5;
audio.src = allSongs[0].path;
songName.innerHTML = allSongs[0].name;
artistName.innerHTML = allSongs[0].artist;
artWork.src = allSongs[0].art;
pauseMusic.style.display = "block";
playMusic.style.display = "none";
prevMusic.style.display = "none";
...
const redFooter = document.querySelector(".redFooter"),
  redFooter1 = document.querySelectorAll(".redFooter1"),
  orangeFooter = document.querySelectorAll(".orangeFooter"),
  orangeFooter1 = document.querySelector(".orangeFooter1");
...
const observerDesignFooter = new IntersectionObserver((entries) => {
  entries.forEach((entry) => {
    if (entry.isIntersecting) {
      ...
      redFooter1[1].classList.add("redFooter1Transition");
      orangeFooter[0].classList.add("orangeFooterTransition");
...
const initialLoadingContainer = document.querySelector(
...
const loaderGalleryOutterContainer = document.querySelector(
...
window.addEventListener("load", function () {
  ...
  setTimeout(function () {
    ...
    function progressBar() {
      var randomize = Math.random() * (0.65 - -0.05) + -0.05;
      ...
      const tyGP1 =
        parseFloat(gp1Style.getPropertyValue("--transformY")) || -100;
      if (tyGP1 >= -0.2) {
      ...
      const tyGP2 =
        parseFloat(gp2Style.getPropertyValue("--transformY")) || -100;
      if (tyGP2 >= 0.1) {
        galleryPart2.style.setProperty("--transformY", tyGP2 + 0);
        galleryPart2.classList.add("colorHover");
      } else {
        galleryPart2.style.setProperty(
          "--transformY",
          tyGP2 + randomize + 0.35
        );
      }

      const tyGP3 =
        parseFloat(gp3Style.getPropertyValue("--transformY")) || -100;
      if (tyGP3 >= -0.2) {
        galleryPart3.style.setProperty("--transformY", tyGP3 + 0);
        galleryPart3.classList.add("colorHover");
      } else {
        galleryPart3.style.setProperty(
          "--transformY",
          tyGP3 + randomize + 0.45
        );
      }

      const tyGP4 =
        parseFloat(gp4Style.getPropertyValue("--transformY")) || -100;
      if (tyGP4 >= -0.2) {
        galleryPart4.style.setProperty("--transformY", tyGP4 + 0);
        galleryPart4.classList.add("colorHover");
      } else {
        galleryPart4.style.setProperty(
          "--transformY",
          tyGP4 + randomize + 0.65
        );
      }

      const tyGP5 =
        parseFloat(gp5Style.getPropertyValue("--transformY")) || -100;
      if (tyGP5 >= -0.2) {
      ...
      const tyGP6 =
        parseFloat(gp6Style.getPropertyValue("--transformY")) || -100;
      if (tyGP6 >= -0.2) {
        galleryPart6.style.setProperty("--transformY", tyGP6 + 0);
        galleryPart6.classList.add("colorHover");
      } else {
        galleryPart6.style.setProperty(
          "--transformY",
          tyGP6 + randomize + 0.85
        );
      }
...
loadingImgClick.addEventListener("click", () => {
  ...
  setTimeout(() => {
    initialLoadingContainer.classList.toggle(
      "initialLoadingContainerTransition"
    );
    window.scrollTo(0, 0);
    audio.play();
    audio.volume = 0.5;
...
setInterval(function () {
  ...
  const headerHeadLinesWidth = parseFloat(
    headerHeadlinesStyle.getPropertyValue("width")
  );
  const headerNewsPStyle = getComputedStyle(headerNewsP);
  const headerNewsPWidth = parseFloat(
    headerNewsPStyle.getPropertyValue("width")
  );
...
headerAboutCard.addEventListener("touchmove", () => {
  aboutCardScroll = false;
});
headerAboutCard.addEventListener("touchstart", () => {
  aboutCardScroll = false;
});
headerAboutCard.addEventListener("touchend", () => {
  aboutCardScroll = true;
});
$(".headerAboutCard").hover(
  function () {
    aboutCardScroll = false;
  },
  function () {
...
headerManifestoCard.addEventListener("touchmove", () => {
  manifestoCardScroll = false;
});
headerManifestoCard.addEventListener("touchstart", () => {
  manifestoCardScroll = false;
});
headerManifestoCard.addEventListener("touchend", () => {
  manifestoCardScroll = true;
});
$(".headerManifestoCard").hover(
  function () {
    manifestoCardScroll = false;
  },
  function () {
...
phoneChatContainer.addEventListener("touchmove", () => {
  FaqChatPause = true;
});
phoneChatContainer.addEventListener("touchstart", () => {
  FaqChatPause = true;
});
phoneChatContainer.addEventListener("touchend", () => {
  FaqChatPause = false;
});
$(".phoneChatContainer").hover(
  function () {
    FaqChatPause = true;
  },
  function () {
...
const headerSneakPeeksReveal = document.querySelector(
  ".headerSneakPeeksReveal"
);
const headerPeek = document.querySelectorAll(".headerPeek");
const redLine = document.querySelectorAll(".redLine");
const headerSneakPeeksGallery = document.querySelector(
  ".headerSneakPeeksGallery"
);
...
let peekInfo = [
  {
    ...
    skill1d:
      "Allows the user to transform into their dark form enhancing their physical and magic capabilities.",

    skill2: "Demon’s Touch",
    skill2d:
      "Enables the user to turn anything they touch into a cursed weapon.",

    skill3: "Demon Affinity",
    skill3d:
      "User calls on Cursed Spirits when injured for healing. Cursed Spirits cannot be used for offensive attacks.",
  ...
  },
  {
    ...
    name: "YUI",
    skillIntro:
      "A CXGNUS who specializes in fighting with her self-invented technology.",

    skill1: "Mech Urbane",
    skill1d:
      "User is talented in creating many different pieces of equipment and weapons to aid them in battle with any material available in any situation.",

    skill2: "Ease Tempo",
    skill2d:
      "User has maximum mastery of different kinds of guns and machinery for assault.",
  ...
  },
  {
    ...
    skill1d:
      "The user has a high affinity with spirits and has a contract between them. This ability also makes the user unaffected by status ailments.",

    skill2: "Divine Salvation",
    skill2d:
      "Allows the user to contact spirits they have contracts with and use them for battle. The user can afford a variety of specialties that range from offense to support. ",
  ...
  },
  {
    ...
    skill1: "Icy Torrent",
    skill1d:
      "Allows the user to produce and manipulate water and ice. Can increase volume of his attacks.",

    skill2: "Absolute Zero",
    skill2d:
      "Enables user to freeze things and opponents to absolute zero temperatures causing targets to crumble to pieces under their own weight quickly.",
  ...
  },
  {
    ...
    skill2: "Maxima Volt",
    skill2d:
      "User’s body is filled with electricity, increasing their speed to a maximum speed of lightning and creating a force around the user’s body for defense.",
  ...
  },
  {
    ...
    skill2: "Hot Hands",
    skill2d:
      "Enables the user to raise their fire to a maximum temperature, turning their flames into blue that enhances the user’s physical prowess.",
...
const headerFaqTitle = document.querySelector(".headerFaqTitle"),
  headerFaqNum = document.querySelector(".headerFaqNum"),
  headerFaqContent = document.querySelector(".headerFaqContentP");
headerFaqContent.innerHTML = faq[0].message;
headerFaqNum.innerHTML = faq[0].num;
headerFaqTitle.innerHTML = faq[0].question;
const headerFaqRedLineContent = document.querySelector(
  ".headerFaqRedLineContent"
);
const headerFaqNext = document
  .querySelector(".headerFaqNext")
...
let bios = [
  ...
  },
  {
    ...
    twUn: "@Meek_drills",
    dp: "/imgs/team/xius.png",
    lvl: "34",
    org: "Nigeria",
  },
  {
    bio: "A Daddy by day, NFT and Crypto Enthusiast at night. Experienced Collab Manager and certified Alpha hunter. <br> Saying hello doesn't have an ROI. It's about building relationships.  ",
    tw: "https://twitter.com/LuckNFTvOLtia",
    twUn: "@LuckNFTvOLtia",
    dp: "/imgs/team/judas.png",
    lvl: "29",
    org: "Philippines",
  },
  {
...
let chap1Content = [
  {
    ...
    chap1Content:
      "The release of the CXGNUS original light novel featuring CXGNUS heroes.",
  ...
  },
  {
    ...
    chap1Content:
      "Creation of (DAO) exclusive for holders. Exciting events and exclusive perks will be made available.",
  },
  {
    chap1Title: "CXGNUS OST ALBUM",
    chap1Content:
      "The release of the CXGNUS OST album follow the genre and musical colors appropriate to the NFT and the light novel.",
    page: "page 2 out of 5",
  },
  {
    chap1Title: "CXGNUS OFFICIAL MERCHANDISE",
    chap1Content:
      "The official merchandise ranges from clothing items such as streetwear, art prints, and other items that will be requested by the community.",
  },
  {
    chap1Title: "STAKING",
    chap1Content:
      "CXGNUS NFT holders will receive an admission letter to CXGNUS Academy. By registering (staking), characters will go under training in order to become full-fledged heroes of society.",
  ...
  },
  {
    ...
    chap1Content:
      "When CXGNUS character is admitted to CXGA (CXGNUS Academy) they will accumulate EXP (experience) that will help them level up and will be entitled to earn CXG$ tokens.",
  },
  {
    chap1Title: "LEVEL-UP SYSTEM",
    chap1Content:
      "- There will be level-up milestone perks that will be announced in the latter part of your journey. <br> <span>[The milestone perks will consist of exclusive raffle entries.]</span>",
    page: "page 4 out of 5",
  },
  {
    chap1Title: "CXG$ TOKEN",
    chap1Content:
      "- CXG$ is the official community currency.<br>- Holders willl earn CXG$ per day after admitting their characters to CXGA.<br>- CXG$ can be used to buy whitelist spots, official merchandise, and items to help heroes complete CXGA missions.",
  },
  {
    chap1Title: "CXGNUS STORE",
    chap1Content:
      "More things that can be bought with CXG$ willl be available here. Stay tuned!",
...
let chap2Content = [
  {
    ...
    chap2Content:
      "All information and other details of the game are to be announced. Keep an eye out!",
    pageMV: "page 1 out of 1",
  ...
  },
  {
    ...
    chap2Content:
      "As CXGNUS is a community-driven project, this is to give value to the community and uplift other artists and creators.",
  },
  {
    chap2Title: "END?",
    chap2Content:
      "More chapters should be added as we progress through our journey in the CXGNUS Universe",
    page: "page 2 out of 2",
  },
  {
    chap2Title: "",
...
chapNextBtn.addEventListener("click", function () {
  if (chapSelection == "prol") {
    ...
    chapContentContext[1].innerHTML =
      prolContent[chapContextIndex + 1].prolContent;
  ...
  if (chapSelection == "chap1") {
    ...
    chapContentContext[0].innerHTML =
      chap1Content[chapContextIndex].chap1Content;

    chapContentTitle[1].innerHTML =
      chap1Content[chapContextIndex + 1].chap1Title;
    chapContentContext[1].innerHTML =
      chap1Content[chapContextIndex + 1].chap1Content;
  ...
  if (chapSelection == "chap2") {
    ...
    chapContentContext[0].innerHTML =
      chap2Content[chapContextIndex].chap2Content;

    chapContentTitle[1].innerHTML =
      chap2Content[chapContextIndex + 1].chap2Title;
    chapContentContext[1].innerHTML =
      chap2Content[chapContextIndex + 1].chap2Content;
...
const chaptersContentScrollContainer = document.querySelector(
  ".chaptersContentScrollContainer"
);
...
chapProlMV.addEventListener("click", function () {
  ...
  chapContentContextMV[0].innerHTML =
    prolContent[chapContextIndexMV].prolContent;

  chapContentTitleMV[1].innerHTML =
    prolContent[chapContextIndexMV + 1].prolTitle;
  chapContentContextMV[1].innerHTML =
    prolContent[chapContextIndexMV + 1].prolContent;

  chapContentTitleMV[2].innerHTML =
    prolContent[chapContextIndexMV + 2].prolTitle;
  chapContentContextMV[2].innerHTML =
    prolContent[chapContextIndexMV + 2].prolContent;

  chapContentTitleMV[3].innerHTML =
    prolContent[chapContextIndexMV + 3].prolTitle;
  chapContentContextMV[3].innerHTML =
    prolContent[chapContextIndexMV + 3].prolContent;
...
chap1MV.addEventListener("click", function () {
  ...
  chapContentContextMV[0].innerHTML =
    chap1Content[chapContextIndexMV].chap1Content;

  chapContentTitleMV[1].innerHTML =
    chap1Content[chapContextIndexMV + 1].chap1Title;
  chapContentContextMV[1].innerHTML =
    chap1Content[chapContextIndexMV + 1].chap1Content;

  chapContentTitleMV[2].innerHTML =
    chap1Content[chapContextIndexMV + 2].chap1Title;
  chapContentContextMV[2].innerHTML =
    chap1Content[chapContextIndexMV + 2].chap1Content;

  chapContentTitleMV[3].innerHTML =
    chap1Content[chapContextIndexMV + 3].chap1Title;
  chapContentContextMV[3].innerHTML =
    chap1Content[chapContextIndexMV + 3].chap1Content;
...
chap2MV.addEventListener("click", function () {
  ...
  chapContentContextMV[0].innerHTML =
    chap2Content[chapContextIndexMV].chap2Content;

  chapContentTitleMV[1].innerHTML =
    chap2Content[chapContextIndexMV + 1].chap2Title;
  chapContentContextMV[1].innerHTML =
    chap2Content[chapContextIndexMV + 1].chap2Content;

  chapContentTitleMV[2].innerHTML =
    chap2Content[chapContextIndexMV + 2].chap2Title;
  chapContentContextMV[2].innerHTML =
    chap2Content[chapContextIndexMV + 2].chap2Content;

  chapContentTitleMV[3].innerHTML =
    chap2Content[chapContextIndexMV + 3].chap2Title;
  chapContentContextMV[3].innerHTML =
    chap2Content[chapContextIndexMV + 3].chap2Content;
...
cBA.addEventListener("click", function () {
  ...
  if (chapSelection == "chap1") {
    ...
    chapContentTitleMV[0].innerHTML =
      chap1Content[chapContextIndexMV].chap1Title;
    chapContentContextMV[0].innerHTML =
      chap1Content[chapContextIndexMV].chap1Content;
  ...
  if (chapSelection == "chap2") {
    ...
    chapContentTitleMV[0].innerHTML =
      chap2Content[chapContextIndexMV].chap2Title;
    chapContentContextMV[0].innerHTML =
      chap2Content[chapContextIndexMV].chap2Content;
...
const stakingTrigger = document.querySelector("#rightMenuStaking");
...
mintTrigger.addEventListener("click", function () {
  ...
  setTimeout(function () {
    window.location = "https://mint.studiocxgnus.com/";
  }, 2000);
});

stakingTrigger.addEventListener("click", function () {
  menuMainContainer.classList.add("pointNone");
  html.style.overflow = "unset";
  footerSection.style.display = "none";
  ...
  setTimeout(function () {
    window.location.href = "https://staking.studiocxgnus.com/";
  }, 2000);
});
